...
Page({
  ...
  wanttobuy:function(e){
    ...
    if (this.data.SellUpArray[buyind] == 0)//说明没点赞过
    {
      ...
      const db = wx.cloud.database({ env: 'ji-9gng9vk76e3c65f1' })
   ...
   let that = this
    wx.getStorage({
      ...
      success(res) {
        ...
        ////
        var db = wx.cloud.database()//{ env: 'ji-9gng9vk76e3c65f1' }
        let userid = res.data;
    ...
    const get_inf_db = wx.cloud.database()//{ env: 'ji-9gng9vk76e3c65f1' }
...
get_Sell_DBinf:function(){
  ...
  const get_Sell_inf_db = wx.cloud.database()//{ env: 'ji-9gng9vk76e3c65f1' }
